...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    category: "crystals",
    readTime: "10 min read",
    title: "Crystals for Abundance & Prosperity: A Practical Wealth Guide",
    excerpt: "Abundance isn't only about money - it's the quiet certainty that there's enough, and that more can flow. Here are the stones linked to prosperity through the centuries, and a grounded way to actually work with them instead of just owning them.",
    image: "/images/p012.webp",
    content: `<p>Ask ten crystal lovers about "prosperity" and nine will hand you a Citrine. There's a reason the association is so old: for most of human history, the stones people tied to wealth were the ones that looked like sunlight, like growth, like something earned. Abundance isn't only a bank balance - it's the feeling that there's enough and that more can flow. Here are the stones traditionally linked to prosperity, and a practical way to make them part of how you actually live, not just part of a shelf.</p>
      <h3>Citrine - The Merchant's Stone</h3>
      <p>If prosperity has a poster child, it's Citrine. Its warm gold color reads as sunlight and harvest, and traders have carried it for centuries as a "money stone." The <a href="/products/citrine-merchant-s-ring/">Citrine Merchant's Ring</a> keeps that energy on the hand you write and shake with - a small, daily nudge toward "I create value." Wear it on the left, receiving wrist, or keep a tumble in your wallet. Reset it monthly with smoke or moonlight using the <a href="/blog/how-to-cleanse-your-crystals-7-safe-methods-and-what-not-to-do/">cleansing guide</a>.</p>
      <h3>Green Phantom - The Wealth Builder</h3>
      <p>Where Citrine is the spark, Green Phantom is the slow builder. The green phantom "ghost" inside the quartz is read as layered, compounding growth - the stone for people who think in years, not paychecks. The <a href="/products/green-phantom-wealth-bracelet/">Green Phantom Wealth bracelet</a> is the piece to wear when you're building something: a business, a savings habit, a skill. It pairs naturally with Citrine if you want both the spark and the structure.</p>
      <h3>Tiger's Eye - The Confident Closer</h3>
      <p>Prosperity often comes down to one nerve: asking, negotiating, finishing. Tiger's Eye is the stone of grounded confidence - the "I belong in this room" energy that turns preparation into action. The <a href="/products/tiger-s-eye-warrior-bracelet/">Tiger's Eye Warrior bracelet</a> on the right wrist is armor for pitches, prices, and hard conversations. For the inner-work side of confidence, our <a href="/blog/crystals-for-confidence-courage-self-esteem-wear-your-inner-power/">confidence guide</a> goes deeper.</p>
      <h3>Clear Quartz - The Amplifier</h3>
      <p>Clear Quartz does nothing alone and everything with help - it's the amplifier. Put one near any prosperity stone and it's said to magnify that stone's intent. The <a href="/products/clear-quartz-master-healer-bracelet/">Clear Quartz Master Healer bracelet</a> is the neutral backbone of any wealth combo; a small point on your desk "charges" the layout around it. It's also the stone to use for cleansing the rest, as the <a href="/blog/crystal-care-101-how-to-cleanse-charge-store-your-stones/">Crystal Care 101 guide</a> explains.</p>
      <h3>The Trinity Stack - Citrine + Amethyst + Clear Quartz</h3>
      <p>For a complete prosperity setup, the <a href="/products/amethyst-citrine-clear-quartz-trinity-bracelet/">Amethyst, Citrine & Clear Quartz Trinity bracelet</a> bundles the three jobs: Citrine for attraction, Amethyst for the clear, calm mind that holds the vision, and Clear Quartz to amplify both. It's the "want it, picture it, amplify it" stack in one piece - a clean entry point if you don't want to build a combo from scratch.</p>
      <h3>A 5-Minute Abundance Ritual (That Isn't Woo-Woo)</h3>
      <p>You don't need candles. Once a morning: hold your Citrine or Green Phantom, name one concrete thing you're building this week, and decide the single next step for it. The stone is just the cue that says "we're allowed to want more, and we're taking one step toward it." Do it for a week and the step-taking becomes the habit, stone or not. For the bigger-picture version, our <a href="/blog/crystals-for-manifestation-a-practical-step-by-step-guide/">manifestation guide</a> walks the full intention-setting method.</p>
      <h3>Stack It With the Rest of Your Practice</h3>
      <p>Prosperity doesn't live alone. Pair these stones with the <a href="/blog/crystals-for-career-success-workplace-confidence/">career-success stones</a> for work momentum and the <a href="/blog/crystals-for-luck-good-fortune-opening-doors/">luck-and-opportunity stones</a> for the doors you can't force. Browse <a href="/shop/">the full collection</a> and start with one piece that feels like a yes - because the best prosperity crystal is the one you'll actually keep close, not the one that looks best in a photo.</p>`
  },
  {
    id: "b47",
    category: "guides",
    readTime: "11 min read",
    title: "The Crystal Color Meaning Guide: What Each Hue Symbolizes",
    excerpt: "Why do we reach for pink when we need comfort and purple when we need quiet? Crystal color isn't just pretty - it's the fastest way to choose a stone by intention. Here's what each hue tends to mean, and which Aurae pieces carry it.",
    image: "/images/p003.webp",
    content: `<p>New to crystals, the color is the first thing your eye catches - and it turns out to be the most useful filter you have. Long before you learn a stone's name, its color already tells you what people have reached for it for across cultures and centuries. Pink reads as love, green as growth, black as protection. This guide maps the main hues to their intentions so you can pick by color first, then confirm by feel.</p>
      <h3>Pink - Love, Gentleness & Self-Comfort</h3>
      <p>Pink is the heart color. It's the stone you reach for when the work is softening - toward yourself, toward someone, toward a kinder inner voice. The <a href="/products/rose-quartz-love-bracelet/">Rose Quartz Love bracelet</a> is the classic everyday heart stone, and the <a href="/products/rose-strawberry-quartz-harmony-bracelet/">Rose & Strawberry Quartz Harmony bracelet</a> leans into warm, open connection. Pair the intention with our <a href="/blog/crystals-for-love-relationships-self-love-a-gentle-guide/">love & self-love guide</a>.</p>
      <h3>Purple - Calm, Wisdom & the Inner Life</h3>
      <p>Purple has read as "quiet mind" for as long as people have named stones. It's the color for settling mental noise and tuning into intuition. The <a href="/products/amethyst-serenity-bracelet/">Amethyst Serenity bracelet</a> is the everyday calm piece, while the <a href="/products/amethyst-crown-of-wisdom-necklace/">Amethyst Crown of Wisdom necklace</a> sits at the third eye for meditation and reflection. For the practice around it, see the <a href="/blog/crystals-for-meditation-mindfulness-build-a-calmer-daily-practice/">meditation guide</a>.</p>
      <h3>Yellow & Gold - Joy, Confidence & Prosperity</h3>
      <p>Sun-colored stones carry sun-colored meanings: warmth, self-belief, and the energy of attraction. The <a href="/products/citrine-merchant-s-ring/">Citrine Merchant's Ring</a> is the prosperity stone; <a href="/products/tiger-s-eye-warrior-bracelet/">Tiger's Eye</a> adds grounded courage to act; and <a href="/products/rutilated-quartz-power-bracelet/">Rutilated Quartz</a> brings a charged, "go get it" push. The <a href="/blog/crystals-for-confidence-courage-self-esteem-wear-your-inner-power/">confidence guide</a> builds on the same current.</p>
      <h3>Green - Growth, Wealth & the Heart in Action</h3>
      <p>Green is the color of things that grow: money, health, second chances. The <a href="/products/green-phantom-wealth-bracelet/">Green Phantom Wealth bracelet</a> is the builder's stone, and the <a href="/products/liangshan-nanhong-agate-bracelet/">Liangshan Nanhong Agate bracelet</a> carries a deeper, earthy red-green warmth for vitality and steady roots.</p>
      <h3>Blue - Communication, Calm & Truth</h3>
      <p>Blue is the throat and the sky - the color of saying the true thing and staying cool while you do. The <a href="/products/aquamarine-ocean-calm-necklace/">Aquamarine Ocean Calm necklace</a> is the exhale stone; <a href="/products/blue-quartz-serenity-bracelet/">Blue Quartz</a> cools a racing mind; and the <a href="/products/lapis-lazuli-royal-phoenix-tassel-earrings/">Lapis Lazuli Royal Phoenix earrings</a> carry old-world "speak with authority" energy. The <a href="/blog/crystals-for-communication-the-throat-chakra-speak-with-confidence/">throat-chakra guide</a> goes deeper.</p>
      <h3>White & Clear - Clarity, Amplification & Purity</h3>
      <p>Clear and white stones are the neutrals - they clarify and they amplify whatever you set beside them. The <a href="/products/clear-quartz-master-healer-bracelet/">Clear Quartz Master Healer bracelet</a> is the all-purpose amplifier; the <a href="/products/clear-quartz-purity-bracelet/">Clear Quartz Purity bracelet</a> keeps the intention clean; and the <a href="/products/moonstone-divine-feminine-pendant/">Moonstone Divine Feminine pendant</a> adds a soft, intuitive shimmer. Use Clear Quartz to charge the rest, as the <a href="/blog/crystal-care-101-how-to-cleanse-charge-store-your-stones/">Crystal Care 101 guide</a> describes.</p>
      <h3>Red - Vitality, Passion & Warmth</h3>
      <p>Red is blood and fire - the color of energy that moves. The <a href="/products/garnet-phoenix-vitality-bracelet/">Garnet Phoenix Vitality bracelet</a> is the "come back to life" stone, and the <a href="/products/zijin-cinnabar-calm-pendant/">Zijin Cinnabar Calm pendant</a> pairs red with a grounding calm so the fire doesn't burn you out.</p>
      <h3>Black & Dark - Protection & Grounding</h3>
      <p>Black stones are the roots and the shield - the color of "nothing gets through that I don't let through." The <a href="/products/black-gold-obsidian-shield-bracelet/">Black Gold Obsidian Shield bracelet</a> is everyday armor; the <a href="/products/black-obsidian-mirror-of-truth-pendant/">Black Obsidian Mirror of Truth pendant</a> adds a reflective, "see clearly" edge; and the <a href="/products/silver-sheen-obsidian-pendant/">Silver Sheen Obsidian pendant</a> softens the protection with a quiet metallic sheen.</p>
      <h3>Iridescent & Brown - Intuition & Earth</h3>
